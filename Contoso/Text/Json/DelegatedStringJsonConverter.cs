...
namespace Contoso.Text.Json
{
    ...
    public class DelegatedStringJsonConverter<T> : JsonConverter<T>
        where T : notnull
    {
        private static readonly bool STypeAllowsNull = !typeof(T).IsValueType || Nullable.GetUnderlyingType(typeof(T)) != null;
        ...
        public override T Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            if (!STypeAllowsNull && reader.TokenType == JsonTokenType.Null)
